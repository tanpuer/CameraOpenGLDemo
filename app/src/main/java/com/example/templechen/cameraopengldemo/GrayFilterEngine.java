...
public class GrayFilterEngine extends BaseFilterEngine{
    ...
    public GrayFilterEngine(Context context, int OESTextureId){
        ...
        vertexShader = Utils.loadShader(GL_VERTEX_SHADER, Utils.readShaderFromResource(context,R.raw.gray_vertex_shader));
        fragmentShader = Utils.loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(context,R.raw.gray_fragment_shader));
